package com.example.inventory_service.infrastructure.aop;
...
public class LoggingAspect {
    ...
    // Intercepta cualquier mwtodo dentro del paquete application.usecase (y subpaquetes)
    @Around("execution(* com.example.inventory_service.application.usecase..*.execute(..))")
