package com.example.dispatch_service.infrastructure.aop;
...
public class LoggingAspect {
    ...
    // Intercepta cualquier metodo dentro del paquete application.usecase (y subpaquetes)
    @Around("execution(* com.example.dispatch_service.application.usecase..*.execute(..))")
